package polinema.mysqlmultipletable;
...
import polinema.mysqlmultipletable.adapter.Adapter;
import polinema.mysqlmultipletable.app.AppController;
import polinema.mysqlmultipletable.data.Data;
import polinema.mysqlmultipletable.util.Server;
    ...
    private void edit(final String idx){
        StringRequest strReq = new StringRequest(Request.Method.POST, url_edit, new
            ...
            protected Map<String, String> getParams() {
                // Posting parameters ke post url
                Map<String, String> params = new HashMap<String, String>();
                params.put("id", idx);return params;
            }
        };
        AppController.getInstance().addToRequestQueue(strReq, tag_json_obj);
    }
